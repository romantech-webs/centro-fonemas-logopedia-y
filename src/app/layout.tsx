  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-fonemas-logopedia-y";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Centro Fonemas LOGOPEDIA y PEDAGOGÍA"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="centro-fonemas-logopedia-y"
          data-primary-color="#99c7d3"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="centro-fonemas-logopedia-y";
